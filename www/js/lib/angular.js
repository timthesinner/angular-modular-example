/**
 * @license AngularJS v1.2.15-build.local+sha.d07101d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.local+sha.d07101d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.local+sha.d07101d',    // all of these placeholder strings will be replaced by grunt's
